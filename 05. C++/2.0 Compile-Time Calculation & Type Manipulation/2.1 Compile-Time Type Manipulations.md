...
This template class holds if the argument class is capable of storing real values.
```cpp
...
---
#### Another variant of checking if provided type 'NumberType' represents a real number.
```cpp
template< typename NumberType >
...
>[!WARNING] This is NOT SAFE. Controversal examples:
--> rational numbers,
--> complex numbers.
...
        // Answer: Because we have not defined a is_function template, that takes 
